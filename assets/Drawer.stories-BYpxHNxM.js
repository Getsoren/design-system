import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{Gi as n,Ir as r,Kn as i,Qt as a,Vr as o,Ya as s,Zn as c,at as l,d as u,f as d,fn as f,ln as p,m,on as h,p as g,tn as _}from"./iframe-BJWYUZp-.js";var v,y=e((()=>{m(),u(),v=e=>d(i,{...e});try{v.displayName=`Drawer`,v.__docgenInfo={description:``,displayName:`Drawer`,filePath:`/home/runner/work/design-system/design-system/src/components/Navigation/Drawer/stories/Drawer.tsx`,methods:[],props:{component:{defaultValue:null,declarations:[{fileName:`design-system/node_modules/@mui/material/esm/Modal/Modal.d.ts`,name:`TypeLiteral`}],description:``,name:`component`,required:!1,tags:{},type:{name:`ElementType<any, keyof IntrinsicElements>`}},slots:{defaultValue:{value:`{}`},declarations:[{fileName:`design-system/node_modules/@mui/material/esm/utils/types.d.ts`,name:`TypeLiteral`}],description:`The components used for each slot inside.`,name:`slots`,required:!1,tags:{default:`{}`},type:{name:`Partial<DrawerSlots>`}},slotProps:{defaultValue:{value:`{}`},declarations:[{fileName:`design-system/node_modules/@mui/material/esm/utils/types.d.ts`,name:`TypeLiteral`}],description:`The props used for each slot inside.`,name:`slotProps`,required:!1,tags:{default:`{}`},type:{name:`{ root?: SlotProps<ElementType<ModalProps, keyof IntrinsicElements>, DrawerRootSlotPropsOverrides, DrawerOwnerState>; backdrop?: SlotProps<...>; docked?: SlotProps<...> | undefined; paper?: SlotProps<...> | undefined; transition?: SlotProps<...> | undefined; } | undefined`}}},tags:{}}}catch{}})),b,x,S,C,w;e((()=>{m(),b=t(s(),1),y(),u(),x=e=>{let[t,i]=(0,b.useState)({bottom:!1,left:!1,right:!1,top:!1}),s=d(n,{className:`MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-vubbuv`,focusable:`false`,"aria-hidden":`true`,viewBox:`0 0 24 24`,"data-testid":`FavoriteIcon`,children:d(`path`,{d:`m12 21.35-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z`})}),u=(e,n)=>r=>{r.type===`keydown`&&(r.key===`Tab`||r.key===`Shift`)||i({...t,[e]:n})},m=e=>g(o,{sx:{width:e===`top`||e===`bottom`?`auto`:250},role:`presentation`,onClick:u(e,!1),onKeyDown:u(e,!1),children:[d(f,{children:[`Inbox`,`Starred`,`Send email`,`Drafts`].map(e=>d(h,{disablePadding:!0,children:g(p,{children:[d(_,{children:s}),d(a,{primary:e})]})},e))}),d(c,{}),d(f,{children:[`All mail`,`Trash`,`Spam`].map(e=>d(h,{disablePadding:!0,children:g(p,{children:[d(_,{children:s}),d(a,{primary:e})]})},e))})]});return d(l,{direction:`row`,spacing:1,display:`flex`,alignItems:`center`,justifyContent:`center`,height:`100%`,children:[`left`,`right`,`top`,`bottom`].map(n=>g(b.Fragment,{children:[d(r,{onClick:u(n,!0),variant:`outlined`,children:n}),d(v,{anchor:n,open:t[n],onClose:u(n,!1),...e,children:m(n)})]},n))})},S=x.bind({}),S.args={},C={component:v,title:`Components/Navigation/Drawer`},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`args => {
