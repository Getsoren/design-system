import{i as e}from"./preload-helper-xPQekRTU.js";import{Ki as t,Lr as n,Mr as r,_t as i,at as a,c as o,l as s,m as c,mt as l,qr as u,s as d,vi as f}from"./iframe-KIu7hbaN.js";import{n as p,t as m}from"./Tooltip-CQMndno4.js";var h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A;e((()=>{c(),p(),d(),h=t(({children:e,className:t,...n})=>o(m,{...n,classes:{popper:t},children:e}))({[`& .${l.tooltip}`]:{maxWidth:500}}),g=t(({children:e,className:t,...n})=>o(m,{...n,classes:{popper:t},children:e}))({[`& .${l.tooltip}`]:{maxWidth:`none`}}),_=`
